...
evalBoard2(Board, Player, BoardScore) :-
    ...
    aligned(Board, Opponent, 5, FivesBlockedOpp, 0),
    BoardScorePlayer is 1*Ones+10*Twos+100*Threes+1000*Fours+100000*(FivesBlocked-Fives),
    BoardScoreOpp is 1*OnesOpp+10*TwosOpp+100*ThreesOpp+1000*FoursOpp+100000*(FivesBlockedOpp-FivesOpp),
